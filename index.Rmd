...
div(class = "container-fluid",
  h2("Public parks in Trafford", style = "padding-top: 25px; margin-bottom: 20px;"),
  div(class = "row",
      div(class = "col-xs-12 col-sm-6 col-md-6 col-lg-6", map),
      h4("Park facilities", style = "margin-bottom: 0px; text-indent: 2em;"),
  ...
  br(),
  h4("Park Friends' Groups", style = "margin-bottom: 15px; text-indent: 2.2em;"),
  div(class = "row",
